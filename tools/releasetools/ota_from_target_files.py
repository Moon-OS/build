...
""" % bcb_dev)
  ...
  is_plus = target_info.GetBuildProp("ro.moon.version").endswith(
        "_plus")
  android_version = target_info.GetBuildProp("ro.build.version.release")
  build_id = target_info.GetBuildProp("ro.build.id")
  build_date = target_info.GetBuildProp("ro.moon.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("ro.moon.device")
  script.PrintMoonBanner(android_version, build_id, build_date,
